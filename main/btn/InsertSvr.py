...
class InsertSvr(QDialog):
    ...
    def accepted(self):
        ...
        sys_code = self.sys_list[self.sys_combo.currentIndex()][0]
        gb_code = self.gb_list[self.gb_combo.currentIndex()][0]
